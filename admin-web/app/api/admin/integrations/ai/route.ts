...
export async function PATCH(req: NextRequest) {
  ...
  const privatePayload = {
    ...
    model: asString(body.model, 'glm-4.7-flash').trim(),
    analysisModel: asString(body.analysisModel, asString(body.model, 'glm-4.7-flash')).trim(),
    pricingModel: asString(body.pricingModel, asString(body.model, 'glm-4.7-flash')).trim(),
    missionModel: asString(body.missionModel, asString(body.model, 'glm-4.7-flash')).trim(),
