...
const styles = StyleSheet.create({
  ...
  kicker: { color: Colors.primary, fontSize: Typography.fontSize.xs, fontWeight: Typography.fontWeight.extrabold, textTransform: 'uppercase', letterSpacing: 1.1 },
  title: { color: Colors.textPrimary, fontSize: Typography.fontSize['2xl'], fontWeight: Typography.fontWeight.extrabold },
  ...
  noticeTitle: { color: Colors.warningDark, fontSize: Typography.fontSize.sm, fontWeight: Typography.fontWeight.extrabold },
  ...
  rowValue: { color: Colors.textPrimary, fontSize: Typography.fontSize.sm, fontWeight: Typography.fontWeight.bold },
  rowValueStrong: { color: Colors.primary, fontSize: Typography.fontSize.lg, fontWeight: Typography.fontWeight.extrabold },
  balanceValue: { color: Colors.primary, fontSize: Typography.fontSize['3xl'], fontWeight: Typography.fontWeight.extrabold, textAlign: 'center' },
  ...
  policyTitle: { color: Colors.textPrimary, fontWeight: Typography.fontWeight.extrabold },
  ...
  primaryButtonText: { color: Colors.white, fontWeight: Typography.fontWeight.extrabold, fontSize: Typography.fontSize.base },
  ...
  secondaryButtonText: { color: Colors.textPrimary, fontWeight: Typography.fontWeight.bold, fontSize: Typography.fontSize.sm },
});
