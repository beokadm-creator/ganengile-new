...
const styles = StyleSheet.create({
  ...
  couponSelectedText: { color: Colors.primary, fontWeight: Typography.fontWeight.bold, fontSize: Typography.fontSize.base },
  couponPlaceholderText: { color: Colors.textSecondary, fontWeight: Typography.fontWeight.bold, fontSize: Typography.fontSize.base },
  ...
  quoteLabel: { color: Colors.primary, fontWeight: Typography.fontWeight.bold, fontSize: Typography.fontSize.sm, marginBottom: Spacing.xs },
  ...
  quoteEngineHint: { color: Colors.accent, fontSize: Typography.fontSize.sm, fontWeight: Typography.fontWeight.bold, marginBottom: Spacing.xs },
  ...
  surchargeBadgeText: { color: Colors.warningDark, fontSize: Typography.fontSize.sm, fontWeight: Typography.fontWeight.extrabold },
  ...
  draftActionText: { color: Colors.primary, fontWeight: Typography.fontWeight.bold, fontSize: Typography.fontSize.sm },
