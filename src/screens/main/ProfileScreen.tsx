...
function StatusBadge({ label, tone }: { label: string; tone: 'teal' | 'green' | 'blue' | 'gray' }) {
  const palette = { teal: { bg: '#CCFBF1', fg: '#115E59' }, green: { bg: '#DCFCE7', fg: '#166534' }, blue: { bg: '#DBEAFE', fg: '#1D4ED8' }, gray: { bg: '#E2E8F0', fg: '#475569' } } as const;
...
function StatusPill({ label, tone }: { label: string; tone: 'green' | 'amber' }) {
  const palette = tone === 'green' ? { bg: '#DCFCE7', fg: '#166534' } : { bg: '#FEF3C7', fg: '#92400E' };
  return <View style={[styles.pill, { backgroundColor: palette.bg }]}><Text style={[styles.pillText, { color: palette.fg }]}>{label}</Text></View>;
}

const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: '#F8FAFC' }, content: { padding: Spacing.lg, gap: Spacing.md }, centerState: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8FAFC' }, centerText: { marginTop: Spacing.md, color: '#475569', ...Typography.body }, hero: { backgroundColor: '#FFFFFF', borderRadius: BorderRadius.xl, padding: Spacing.lg, gap: 10, ...Shadows.sm }, kicker: { fontSize: 12, fontWeight: '700', color: '#0F766E', textTransform: 'uppercase', letterSpacing: 1 }, name: { fontSize: 24, fontWeight: '800', color: '#0F172A' }, subtitle: { color: '#475569', ...Typography.body }, badgeRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, badge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 }, badgeText: { fontSize: 12, fontWeight: '700' }, switchButton: { minHeight: 48, borderRadius: BorderRadius.xl, backgroundColor: '#F8FAFC', paddingHorizontal: Spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, switchButtonText: { color: '#0F172A', fontWeight: '700' }, section: { gap: 10 }, sectionTitle: { color: '#0F172A', fontSize: 18, fontWeight: '800' }, readinessCard: { backgroundColor: '#FFFFFF', borderRadius: BorderRadius.xl, padding: Spacing.lg, gap: 8, ...Shadows.sm }, readinessTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, readinessTitle: { color: '#0F172A', fontWeight: '800' }, readinessBody: { color: '#475569', ...Typography.bodySmall }, readinessAction: { color: '#0F766E', fontWeight: '700' }, pill: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5 }, pillText: { fontSize: 12, fontWeight: '700' }, linkCard: { backgroundColor: '#FFFFFF', borderRadius: BorderRadius.xl, padding: Spacing.lg, flexDirection: 'row', alignItems: 'center', gap: 12, ...Shadows.sm }, linkIconWrap: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#ECFDF5', alignItems: 'center', justifyContent: 'center' }, linkCopy: { flex: 1, gap: 4 }, linkTitle: { color: '#0F172A', fontWeight: '800' }, linkSubtitle: { color: '#64748B', ...Typography.caption }, noticeBox: { backgroundColor: '#FFFFFF', borderRadius: BorderRadius.xl, padding: Spacing.lg, gap: 6, ...Shadows.sm }, noticeTitle: { color: '#0F172A', fontWeight: '800' }, noticeBody: { color: '#475569', ...Typography.bodySmall }, logoutButton: { minHeight: 52, borderRadius: BorderRadius.xl, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', ...Shadows.sm }, logoutText: { color: '#DC2626', fontWeight: '800' } });
