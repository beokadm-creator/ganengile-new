...
const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: Colors.background }, content: { padding: 16, paddingBottom: 32, gap: 12 }, centerState: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.background }, centerText: { color: Colors.textSecondary }, hero: { backgroundColor: Colors.surface, borderRadius: 18, padding: 18, gap: 6 }, kicker: { color: Colors.primary, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.1 }, title: { color: Colors.textPrimary, fontSize: 26, fontWeight: '700' }, subtitle: { color: Colors.textSecondary, fontSize: 14, lineHeight: 21 }, modeCard: { borderRadius: 18, padding: 16, gap: 6 }, modeCardTest: { backgroundColor: Colors.warningLight, borderWidth: 1, borderColor: Colors.warning }, modeCardLive: { backgroundColor: Colors.success + '1A', borderWidth: 1, borderColor: Colors.success }, modeTitle: { color: Colors.textPrimary, fontSize: 15, fontWeight: '700' }, modeBody: { color: Colors.textSecondary, fontSize: 13, lineHeight: 19 }, modeMeta: { color: Colors.textSecondary, fontSize: 12 }, statusCard: { backgroundColor: Colors.surface, borderRadius: 18, padding: 18, gap: 10 }, sectionTitle: { color: Colors.textPrimary, fontSize: 17, fontWeight: '700' }, statusBadge: { alignSelf: 'flex-start', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6 }, statusBadgeText: { fontWeight: '700' }, statusDescription: { color: Colors.textSecondary, lineHeight: 20 }, inlineButton: { alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, backgroundColor: Colors.primaryMint }, inlineButtonText: { color: Colors.primary, fontWeight: '700' }, providerSection: { gap: 10 }, providerCard: { backgroundColor: Colors.surface, borderRadius: 18, padding: 16, borderWidth: 1, borderColor: Colors.border, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, providerCardSelected: { borderColor: Colors.primary }, providerCardDisabled: { opacity: 0.6 }, providerCopy: { flex: 1, gap: 4 }, providerTitle: { color: Colors.textPrimary, fontWeight: '700' }, providerSubtitle: { color: Colors.textSecondary, fontSize: 13, lineHeight: 19 }, providerMeta: { color: Colors.textSecondary, fontSize: 12 }, providerAction: { fontWeight: '800' }, noticeBox: { backgroundColor: Colors.surface, borderRadius: 18, padding: 18, gap: 6 }, noticeTitle: { color: Colors.textPrimary, fontWeight: '700' }, noticeBody: { color: Colors.textSecondary, lineHeight: 20 }, primaryButton: { minHeight: 54, borderRadius: 18, backgroundColor: Colors.primary, alignItems: 'center', justifyContent: 'center' }, primaryButtonDisabled: { opacity: 0.7 }, primaryButtonText: { color: Colors.surface, fontWeight: '800', fontSize: 16 } });
